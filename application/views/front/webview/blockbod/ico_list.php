...
<head>
    ...
    <script type="text/javascript" src="<?php echo PUBLIC_FOLDER; ?>js/ico.js"></script>
</head>
...
<div id="page" class="site" style="transform: none;">
    ...
    <div id="content" class="site-content" style="transform: none;">
        ...
        <div class="container" style="transform: none;"><div class="inner-wrapper" style="transform: none;">
                                ...
                                <div class="article-wrap-inner">
                                    <div class="content-wrap">
                                        <div class="content-wrap-inner">
                                            <div id="list" class="entry-content">
                                                <!-- main content here -->
                                                <img src="<?php echo PUBLIC_FOLDER; ?>img/loading.gif" id="loading_icon"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <input type="hidden" id="ico_uri" value="<?php echo $ico_uri; ?>"/>
                <input type="hidden" id="ico_type" value="<?php echo $ico_type; ?>"/>
                        ...
                        <aside id="media_image-3" class="widget widget_media_image">
                            <div class="aligncenter">
                                <script type="text/javascript">
                                    ...
                                    amzn_assoc_default_search_phrase = 'ico manual';
