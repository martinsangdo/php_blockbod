...
<header id="js-header" class="u-header u-header--sticky-top">
    <div class="u-header__section u-header__section--admin-dark g-min-height-65">
                        ...
                        <ul class="p-0 mb-0">
                            ...
                            <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                                <div class="d-flex g-mr-15">
                                    <img class="g-width-40 g-height-40 rounded-circle" src="/public/unity_assets/img-temp/100x100/img5.jpg" alt="Image Description">
                                </div>
                            ...
                            <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                                <div class="d-flex g-mr-15">
                                    <img class="g-width-40 g-height-40 rounded-circle" src="/public/unity_assets/img-temp/100x100/img6.jpg" alt="Image Description">
                                </div>
                            ...
                            <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                                <div class="d-flex g-mr-15">
                                    <img class="g-width-40 g-height-40 rounded-circle" src="/public/unity_assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                </div>
        ...
        <!-- Top Activity Panel -->
        <div id="activityMenu" class="js-custom-scroll u-header-sidebar g-pos-fix g-top-0 g-right-0 g-z-index-4 g-width-300 g-width-400--sm g-height-100vh" aria-labelledby="activityInvoker">
            ...
            [
              ...
              {"meta": "$", "value": 2770}
                    ...
                    <div class="col-xl-4">
                        ...
                        <!-- Calendar Card -->
                        <div class="g-mb-30">
                            <header class="u-bg-overlay g-bg-img-hero g-bg-black-opacity-0_5--after g-rounded-4 g-rounded-0--bottom-left g-rounded-0--bottom-right g-overflow-hidden" style="background-image: url();">
                                ...
                                <section class="u-timeline-v2-wrap g-pos-rel g-left-25--before g-mb-20">
                                    <div class="g-orientation-left g-pos-rel g-ml-25--md g-pl-20">
                                        ...
                                        <div class="media g-mb-16">
                                            <div class="d-flex align-self-center g-mr-15">
                                                <img class="g-width-55 g-height-55 rounded-circle" src="/public/unity_assets/img-temp/100x100/img1.jpg" alt="Image Description">
                                            </div>
                                    ...
                                    <div class="g-orientation-left g-pos-rel g-ml-25--md g-pl-20">
                                        ...
                                        <div class="media g-mb-25">
                                            <div class="d-flex align-self-center g-mr-15">
                                                <img class="g-width-55 g-height-55 rounded-circle" src="/public/unity_assets/img-temp/100x100/img4.jpg" alt="Image Description">
                                            </div>
                                    ...
                                    <div class="g-orientation-left g-pos-rel g-ml-25--md g-pl-20">
                                        ...
                                        <div class="media g-mb-16">
                                            <div class="d-flex align-self-center g-mr-15">
                                                <img class="g-width-55 g-height-55 rounded-circle" src="/public/unity_assets/img-temp/100x100/img5.jpg" alt="Image Description">
                                            </div>
                                    ...
                                    <div class="g-orientation-left g-pos-rel g-ml-25--md g-pl-20">
                                        ...
                                        <div class="media g-mb-16">
                                            <div class="d-flex align-self-center g-mr-15">
                                                <img class="g-width-55 g-height-55 rounded-circle" src="/public/unity_assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                            </div>
                                        ...
                                        <ul class="list-inline d-flex g-mb-20">
                                            <li class="list-inline-item g-mb-10 g-mb-0--sm mr-0">
                                                <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle" src="/public/unity_assets/img-temp/100x100/img4.jpg" alt="Image Description">
                                            </li>
                                            <li class="list-inline-item g-mb-10 g-mb-0--sm g-ml-7 mr-0">
                                                <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle" src="/public/unity_assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                            </li>
                                            <li class="list-inline-item g-mb-10 g-mb-0--sm g-ml-7 mr-0">
                                                <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle" src="/public/unity_assets/img-temp/100x100/img14.jpg" alt="Image Description">
                                            </li>
                                            <li class="list-inline-item g-mb-10 g-mb-0--sm g-ml-7 mr-0">
                                                <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle" src="/public/unity_assets/img-temp/100x100/img15.jpg" alt="Image Description">
                                            </li>
                                            <li class="list-inline-item g-mb-10 g-mb-0--sm g-ml-7 mr-0">
                            ...
                            <div class="js-custom-scroll g-height-400 g-pa-15 g-pa-0-30-25--md">
                                <section class="media">
                                    <div class="d-flex g-mr-12">
                                        <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="/public/unity_assets/img-temp/100x100/img5.jpg" alt="Image Description">
                                    </div>
              ...
              <span class="g-hidden-sm-down">Project</span>
                                ...
                                <section class="media">
                                    <div class="d-flex g-mr-12">
                                        <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="/public/unity_assets/img-temp/100x100/img14.jpg" alt="Image Description">
                                    </div>
              ...
              <span class="g-hidden-sm-down">Project</span>
                                ...
                                <section class="media">
                                    <div class="d-flex g-mr-12">
                                        <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="/public/unity_assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                    </div>
