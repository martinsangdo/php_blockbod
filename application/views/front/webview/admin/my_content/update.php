                    ...
                    <form id="frm_input" name="frm_input" method="post" enctype="multipart/form-data" class="edit_form">
                        ...
                        <div class="d-flex align-items-center form-group g-mb-5">
                            ...
                            if (isset($detail->thumb_url)){
                                echo '<img class="thumb_list g-mr-20" src="'.CONTENT_COVER_PATH.$detail->thumb_url.'"/>';
                            }
                            ?>
                        ...
                        <div class="d-flex align-items-center form-group g-mb-5">
                            ...
                            if (isset($detail->attach_filename)){
                                echo '<a class="g-mr-20" target="_blank" href="'.CONTENT_ATTACH_PATH.$detail->attach_filename.'">Open ('.$detail->file_size_kb.' KB)</a>';
                            }
                            ?>
                            <div class="u-file-attach-v1 g-brd-gray-light-v2">
                                <div class="input-group-btn">
                        ...
                        <div class="d-flex align-items-center form-group g-mb-5">
                            ...
                            <div class="g-pos-rel">
                                <select name="sel_cat_id">
                                    ...
                                    <?php
                                    if ($cat_list){
                                        $selected_cat = $detail->cat_id;
                                        for ($i=0; $i<count($cat_list); $i++){
                                            if ($selected_cat == $cat_list[$i]->_id){
                                                echo '<option value="'.$cat_list[$i]->_id.'" selected>'.$cat_list[$i]->name.'</option>';
                                            } else {
                                                echo '<option value="'.$cat_list[$i]->_id.'">'.$cat_list[$i]->name.'</option>';
                                            }
                                        }
                                    }
                                    ?>
                        ...
                        <div class="d-flex align-items-center form-group g-mb-5">
                            ...
                            <div class="g-pos-rel">
                                <button class="btn btn-md u-btn-blue rounded-0" type="button" onclick="adminMyContent.update();">Save</button>
                            </div>
